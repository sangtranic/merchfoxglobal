...
class Orders extends Model
{
     ...
     */
    protected $fillable = [
        'orderNumber', 'channelId', 'vpsId', 'sellerId', 'shipToAddressID', 'shipToAddressName', 'shipToAddressPhone', 'shipToAddressLine1', 'shipToAddressLine2', 'shipToAddressCity', 'shipToAddressCounty', 'shipToAddressStateOrProvince', 'shipToAddressPostalCode', 'shipToAddressCountry', 'statusId', 'note', 'categoryId', 'productId', 'itemId', 'sku', 'style', 'size', 'color', 'productType', 'quantity', 'price','ship', 'cost', 'profit', 'isFB', 'fulfillStatusId', 'fulfillCode', 'fulfillUserFullName', 'trackingStatusId', 'trackingCode', 'carrier', 'carrierStatusId', 'syncStoreStatusId', 'created_at', 'createBy', 'updated_at', 'updateBy'
    ];
     ...
     */
    protected $casts = [
        'orderNumber' => 'string', 'channelId' => 'string', 'vpsId' => 'int', 'sellerId' => 'int', 'shipToAddressID' => 'string', 'shipToAddressName' => 'string', 'shipToAddressPhone' => 'string', 'shipToAddressLine1' => 'string', 'shipToAddressLine2' => 'string', 'shipToAddressCity' => 'string', 'shipToAddressCounty' => 'string', 'shipToAddressStateOrProvince' => 'string', 'shipToAddressPostalCode' => 'string', 'shipToAddressCountry' => 'string', 'statusId' => 'int', 'note' => 'string', 'categoryId' => 'int', 'itemId' => 'string', 'sku' => 'string', 'style' => 'string', 'size' => 'string', 'color' => 'string', 'productType' => 'string', 'quantity' => 'int', 'price' => 'double','ship' => 'double', 'cost' => 'double', 'profit' => 'double', 'fulfillStatusId' => 'int', 'fulfillCode' => 'string', 'fulfillUserFullName' => 'string', 'trackingStatusId' => 'int', 'trackingCode' => 'string', 'carrier' => 'string', 'carrierStatusId' => 'int', 'syncStoreStatusId' => 'int', 'created_at' => 'timestamp', 'createBy' => 'int', 'updated_at' => 'timestamp', 'updateBy' => 'int'
    ];
